...
"   \n"
"   vec3 objectColour = (0.5f + diffuseFactor)*diffuseColour;\n"
"   \n"
"   //Apply distance fog.\n"
...
"   \n"
"   //Add sun and sky.\n"
"   vec3 skySunColour = texture(skyTexture, vec2(0.5f*(1.0f - positionToSun.y), 1.0f - max(0.01f, normalize(position).y))).xyz\n"
