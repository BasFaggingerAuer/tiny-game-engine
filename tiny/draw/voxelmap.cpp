...
"void main(void)\n"
"{\n"
"   vec4 rayDir = screenToWorld*vec4(2.0f*(gl_FragCoord.xy*inverseScreenSize - 1.0f), nearClippingPlane, 1.0f);\n"
"   \n"
"   rayDir = (rayDir/rayDir.w) - vec4(cameraPosition, 0.0f);\n"
"   \n"
"   vec3 position = cameraPosition + 0.5f*voxelScale*voxelTextureSize;\n"
"   vec3 normal = vec3(0.0f);\n"
"   vec3 diff = vec3(0.0f);\n"
"   \n"
"   castRay(normalize(rayDir.xyz), position, normal, diff);\n"
"   \n"
"   if (normal == vec3(0.0f))\n"
"   {\n"
"       discard;\n"
...
"   \n"
"   diffuse = vec4(diff, 1.0f);\n"
"   //diffuse = vec4(0.5f*(1.0f + normalize(rayDir.xyz)), 1.0f);\n"
"   //diffuse = vec4(1.0f, 1.0f, 0.0f, 1.0f);\n"
"   worldNormal = vec4(normal, 0.0f);\n"
"   //worldNormal = vec4(1.0f, 1.0f, 1.0f, 0.0f);\n"
"   //worldPosition = vec4(cameraPosition + vec3(1.0f, 1.0f, 1.0f), 1.0f);\n"
"   //cameraDepth = 100.0f;\n"
