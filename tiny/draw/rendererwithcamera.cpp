...
RendererWithCamera::RendererWithCamera(const float &aspectRatio, const bool &a_renderToDefaultFrameBuffer, const int &a_viewportWidth, const int &a_viewportHeight) :
    Renderer(a_renderToDefaultFrameBuffer, a_viewportWidth, a_viewportHeight),
