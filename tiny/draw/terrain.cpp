...
"                            f_farMorphFactor));\n"
"   \n"
"   vec3 normal = 2.0f*texture(localNormalTexture, vec3(diffuseScale*f_texturePosition.xy, 255.0f*att.x)).xyz - vec3(1.0f);\n"
"   \n"
"   diffuse = texture(localDiffuseTexture, vec3(diffuseScale*f_texturePosition.xy, 255.0f*att.x));\n"
